...
def generate_pr_body(broken_links: list[BrokenLink]) -> str:
    ...
    for link in broken_links:
        ...
        lines.append(
            f"| `{link['source_file']}` | {link['line_number']} | {original} | {link['status_code']} | {fix} |"
        )
    ...
    lines.extend(
        [
            ...
            "---",
            "",
            "This PR was generated by [Doc-Fix Bot](https://github.com/martymcenroe/gh-link-auditor).",
            "If you'd like to opt out, add `no automated` to your CONTRIBUTING.md or contact the maintainer.",
        ]
    )
