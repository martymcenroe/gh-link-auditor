...
**Operations:** the cadence and procedure for shipping preflight-approved candidates (freshness rule, throughput caps, pause triggers, aging policy) is `docs/runbooks/0001-shipping-the-approved-backlog.md` (#336).
