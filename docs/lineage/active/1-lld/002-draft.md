...
Update Reason: Created LLD for issue #1
-->
...
|----|----------|------|-------|-----------------|---------------|
| 010 | HEAD success no fallback | Auto | URL returning HEAD 200 | status=200, fallback_used=False | No GET request made |
| 020 | HEAD 403 triggers fallback | Auto | URL returning HEAD 403 | GET request made | GET called after HEAD |
| 030 | HEAD 405 triggers fallback | Auto | URL returning HEAD 405 | GET request made | GET called after HEAD |
| 040 | HEAD 404 no fallback | Auto | URL returning HEAD 404 | status=404, fallback_used=False | No GET request made |
| 050 | GET fallback returns status | Auto | HEAD 403, GET 200 | status=200, fallback_used=True | Final status from GET |
| 060 | Fallback check 403 | Auto | status_code=403 | True | Function returns True |
| 070 | Fallback check 405 | Auto | status_code=405 | True | Function returns True |
| 080 | Fallback check 404 | Auto | status_code=404 | False | Function returns False |
| 090 | Timeout handling | Auto | Slow URL | Error result | Timeout respected |
