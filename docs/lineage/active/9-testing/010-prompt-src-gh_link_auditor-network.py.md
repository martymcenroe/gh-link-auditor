# Implementation Request: src/gh_link_auditor/network.py

## Task

Write the complete contents of `src/gh_link_auditor/network.py`.

Change type: Add
Description: Core HTTP request wrapper module
