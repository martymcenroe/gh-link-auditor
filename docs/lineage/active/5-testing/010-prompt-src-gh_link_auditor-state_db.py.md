# Implementation Request: src/gh_link_auditor/state_db.py

## Task

Write the complete contents of `src/gh_link_auditor/state_db.py`.

Change type: Add
Description: Core database module with StateDatabase class
...
### src/gh_link_auditor/__init__.py (full)
