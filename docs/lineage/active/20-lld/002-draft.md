...
Update Reason: Initial LLD creation for dead link investigation subsystem
-->
...
|------|-------------|-------------|
| `src/link_detective.py` | Add | Core investigation orchestrator and ForensicReport dataclass |
| `src/archive_client.py` | Add | Internet Archive CDX API client |
| `src/redirect_resolver.py` | Add | Redirect chain follower with SSRF protection |
| `src/url_heuristic.py` | Add | URL pattern construction from domain + title slugification |
| `src/github_resolver.py` | Add | GitHub API rename/transfer detection |
| `src/similarity.py` | Add | Text similarity scoring utilities |
...
| `docs/wiki/cheery-littlebottom.md` | Add | Character and subsystem documentation |
...
* **Module:** `src/link_detective.py` as orchestrator
...
- [ ] `docs/wiki/cheery-littlebottom.md` created
