# Implementation Request: check_links.py

## Task

Write the complete contents of `check_links.py`.

Change type: Modify
Description: Replace print statements with logger calls
