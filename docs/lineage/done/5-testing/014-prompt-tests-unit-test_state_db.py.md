# Implementation Request: tests/unit/test_state_db.py

## Task

Write the complete contents of `tests/unit/test_state_db.py`.

Change type: Add
Description: Unit tests for state database
...
### src/gh_link_auditor/models.py (full)
